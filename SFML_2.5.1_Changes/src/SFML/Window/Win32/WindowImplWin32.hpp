...
private:
    ...
    /// <MEP Modification>
    /**
    * Provides an implementation of a custom window area testing.
    */
    LRESULT customAreaTest(POINT cursor) const;
    /// </MEP Modification>
...
/// <MEP Modification>
    bool additional_todo = false; ///<In case of modern style.
    bool resizable_modern = false; ///<In case of modern style window need to be resizable.
/// </MEP Modification>
